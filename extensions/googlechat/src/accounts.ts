...
export function listGoogleChatAccountIds(cfg: ArgentConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: ArgentConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: ArgentConfig): ResolvedGoogleChatAccount[] {
