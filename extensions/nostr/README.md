...
Nostr DM channel plugin for ArgentOS using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to ArgentOS. It enables your bot to:
...
# Configure argent to use local relay
