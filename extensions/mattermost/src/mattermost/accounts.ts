...
export function listMattermostAccountIds(cfg: ArgentConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: ArgentConfig): string {
...
export function listEnabledMattermostAccounts(cfg: ArgentConfig): ResolvedMattermostAccount[] {
