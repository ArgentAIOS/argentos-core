import type { ChannelOnboardingAdapter, ArgentConfig, WizardPrompter } from "argent/plugin-sdk";
...
async function noteMattermostSetup(prompter: WizardPrompter): Promise<void> {
  await prompter.note(
    [
      ...
      "Docs: https://docs.argent.ai/channels/mattermost",
    ].join("\n"),
