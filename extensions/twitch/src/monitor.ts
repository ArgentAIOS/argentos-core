...
import type { ReplyPayload, ArgentConfig } from "argent/plugin-sdk";
import { createReplyPrefixOptions } from "argent/plugin-sdk";
...
async function processTwitchMessage(params: {
  ...
  const cfg = config as ArgentConfig;
