...
export function listZalouserAccountIds(cfg: ArgentConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: ArgentConfig): string {
...
function mergeZalouserAccountConfig(cfg: ArgentConfig, accountId: string): ZalouserAccountConfig {
