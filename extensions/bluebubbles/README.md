...
This directory contains the **BlueBubbles external channel plugin** for ArgentOS.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `argent/plugin-sdk` helpers.
