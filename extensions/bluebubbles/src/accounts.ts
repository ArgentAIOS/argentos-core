...
export function listBlueBubblesAccountIds(cfg: ArgentConfig): string[] {
...
export function resolveDefaultBlueBubblesAccountId(cfg: ArgentConfig): string {
...
export function listEnabledBlueBubblesAccounts(cfg: ArgentConfig): ResolvedBlueBubblesAccount[] {
