...
ZIP="$ROOT_DIR/dist/Argent-$VERSION.zip"
DMG="$ROOT_DIR/dist/Argent-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/Argent-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/Argent-$VERSION.dSYM.zip"
