...
show_usage() {
    cat << EOF
clawlog - ArgentOS Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View ArgentOS logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    ArgentOS logs flow through the macOS unified log (subsystem: ai.argentos).
