...
if [[ -z "$version_content" ]]; then
  echo "<h2>ArgentOS $VERSION</h2>"
  echo "<p>Latest ArgentOS update.</p>"
  echo "<p><a href=\"https://github.com/ArgentAIOS/argentos/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
