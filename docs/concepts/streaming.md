...
ArgentOS has two separate “streaming” layers:
...
When block streaming is enabled, ArgentOS can **merge consecutive block chunks**
...
When draft streaming is active, ArgentOS disables block streaming for that reply to avoid double-streaming.
