...
ArgentOS treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.argentos/settings/voicewake.json`

Shape:

```json
{ "triggers": ["argent", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
