...
Deepgram is a speech-to-text API. In ArgentOS it is used for **inbound audio/voice note
transcription** via `tools.media.audio`.

When enabled, ArgentOS uploads the audio file to Deepgram and injects the transcript
