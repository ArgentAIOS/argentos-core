...
You can point ArgentOS at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or ArgentOS
...
- [Anthropic provider](/providers/anthropic) - Native ArgentOS integration with Claude setup-token or API keys
