---
summary: "Frequently asked questions about ArgentOS setup, configuration, and usage"
title: "FAQ"
---
...
- [Quick start and first-run setup](#quick-start-and-firstrun-setup)
  ...
  - [What's the recommended way to install and set up ArgentOS?](#whats-the-recommended-way-to-install-and-set-up-argent)
  ...
  - [I can't access docs.argentos.ai (SSL error). What now?](#i-cant-access-docsargentosai-ssl-error-what-now)
  - [What's the difference between stable and beta?](#whats-the-difference-between-stable-and-beta)
  - [How do I install the beta version, and what's the difference between beta and dev?](#how-do-i-install-the-beta-version-and-whats-the-difference-between-beta-and-dev)
  - [How do I try the latest bits?](#how-do-i-try-the-latest-bits)
  - [How long does install and onboarding usually take?](#how-long-does-install-and-onboarding-usually-take)
  - [Installer stuck? How do I get more feedback?](#installer-stuck-how-do-i-get-more-feedback)
  - [Windows install says git not found or argent not recognized](#windows-install-says-git-not-found-or-argent-not-recognized)
  - [The docs didn't answer my question - how do I get a better answer?](#the-docs-didnt-answer-my-question-how-do-i-get-a-better-answer)
  - [How do I install ArgentOS on Linux?](#how-do-i-install-argent-on-linux)
  - [How do I install ArgentOS on a VPS?](#how-do-i-install-argent-on-a-vps)
  - [Where are the cloud/VPS install guides?](#where-are-the-cloudvps-install-guides)
  - [Can I ask ArgentOS to update itself?](#can-i-ask-argent-to-update-itself)
  ...
  - [If I buy a Mac mini to run ArgentOS, can I connect it to my MacBook Pro?](#if-i-buy-a-mac-mini-to-run-argent-can-i-connect-it-to-my-macbook-pro)
...
- [Can I switch from a legacy package install to the git rail later?](#can-i-switch-from-a-legacy-package-install-to-the-git-rail-later)
  ...
  - [Can I run ArgentOS in a VM and what are the requirements](#can-i-run-argent-in-a-vm-and-what-are-the-requirements)
- [What is ArgentOS?](#what-is-argent)
  - [What is ArgentOS, in one paragraph?](#what-is-argent-in-one-paragraph)
  - [What's the value proposition?](#whats-the-value-proposition)
  - [I just set it up what should I do first](#i-just-set-it-up-what-should-i-do-first)
  - [What are the top five everyday use cases for ArgentOS](#what-are-the-top-five-everyday-use-cases-for-argent)
  - [Can ArgentOS help with lead gen outreach ads and blogs for a SaaS](#can-argent-help-with-lead-gen-outreach-ads-and-blogs-for-a-saas)
...
- [Skills and automation](#skills-and-automation)
  ...
  - [Can ArgentOS run tasks on a schedule or continuously in the background?](#can-argent-run-tasks-on-a-schedule-or-continuously-in-the-background)
...
- [Where things live on disk](#where-things-live-on-disk)
  - [Is all data used with ArgentOS saved locally?](#is-all-data-used-with-argent-saved-locally)
  - [Where does ArgentOS store its data?](#where-does-argent-store-its-data)
  - [Where should AGENTS.md / SOUL.md / USER.md / MEMORY.md live?](#where-should-agentsmd-soulmd-usermd-memorymd-live)
  - [What's the recommended backup strategy?](#whats-the-recommended-backup-strategy)
  - [How do I completely uninstall ArgentOS?](#how-do-i-completely-uninstall-argent)
...
- [Config basics](#config-basics)
  ...
  - [Can the ArgentOS browser run headless?](#can-the-argent-browser-run-headless)
...
- [Remote gateways + nodes](#remote-gateways-nodes)
  ...
  - [Can two ArgentOS instances talk to each other (local + VPS)?](#can-two-argent-instances-talk-to-each-other-local-vps)
...
- [Env vars and .env loading](#env-vars-and-env-loading)
  - [How does ArgentOS load environment variables?](#how-does-argent-load-environment-variables)
...
- [Sessions & multiple chats](#sessions-multiple-chats)
  ...
  - [Is there a way to make a team of ArgentOS instances one CEO and many agents](#is-there-a-way-to-make-a-team-of-argent-instances-one-ceo-and-many-agents)
  - [Why did context get truncated mid-task? How do I prevent it?](#why-did-context-get-truncated-midtask-how-do-i-prevent-it)
  - [How do I completely reset ArgentOS but keep it installed?](#how-do-i-completely-reset-argent-but-keep-it-installed)
  ...
  - [Why doesn't ArgentOS reply in a group?](#why-doesnt-argent-reply-in-a-group)
...
- [Models: defaults, selection, aliases, switching](#models-defaults-selection-aliases-switching)
  ...
  - [What do ArgentOS, Flawd, and Krill use for models?](#what-do-argent-flawd-and-krill-use-for-models)
...
- [Gateway: ports, "already running", and remote mode](#gateway-ports-already-running-and-remote-mode)
  ...
  - [Why does `argent gateway status` say `Runtime: running` but `RPC probe: failed`?](#why-does-argent-gateway-status-say-runtime-running-but-rpc-probe-failed)
  - [Why does `argent gateway status` show `Config (cli)` and `Config (service)` different?](#why-does-argent-gateway-status-show-config-cli-and-config-service-different)
  - [What does "another gateway instance is already listening" mean?](#what-does-another-gateway-instance-is-already-listening-mean)
  - [How do I run ArgentOS in remote mode (client connects to a Gateway elsewhere)?](#how-do-i-run-argent-in-remote-mode-client-connects-to-a-gateway-elsewhere)
...
- [Logging and debugging](#logging-and-debugging)
  ...
  - [I closed my terminal on Windows - how do I restart ArgentOS?](#i-closed-my-terminal-on-windows-how-do-i-restart-argent)
  ...
  - [ELI5: `argent gateway restart` vs `argent gateway`](#eli5-argent-gateway-restart-vs-argent-gateway)
  - [What's the fastest way to get more details when something fails?](#whats-the-fastest-way-to-get-more-details-when-something-fails)
- [Media & attachments](#media-attachments)
  - [My skill generated an image/PDF, but nothing was sent](#my-skill-generated-an-imagepdf-but-nothing-was-sent)
- [Security and access control](#security-and-access-control)
  - [Is it safe to expose ArgentOS to inbound DMs?](#is-it-safe-to-expose-argent-to-inbound-dms)
...
5. **Tail the latest log**
   ...
   ```bash
   tail -f "$(ls -t /tmp/argentos/argent-*.log | head -1)"
   ```
...
7. **Gateway snapshot**
   ```bash
   argent health --json
   argent health --verbose   # shows the target URL + config path on errors
   ```
...
This installs ArgentOS **from a git checkout**, so the agent can read the code + docs and
...
https://github.com/ArgentAIOS/argentos/issues
https://github.com/ArgentAIOS/argentos/pulls
...
- `argent status`: quick snapshot of gateway/agent health + basic config.
- `argent models status`: checks provider auth + model availability.
- `argent doctor`: validates and repairs common config/state issues.

Other useful CLI checks: `argent status --all`, `argent logs --follow`,
`argent gateway status`, `argent health --verbose`.

Quick debug loop: [First 60 seconds if something's broken](#first-60-seconds-if-somethings-broken).
Install docs: [Install](/install), [Installer flags](/install/installer), [Updating](/install/updating).

### What's the recommended way to install and set up ArgentOS
...
- If it asks for auth, run `argent dashboard` and use the tokenized link (`?token=...`).
- The token is the same value as `gateway.auth.token` (or `ARGENTOS_GATEWAY_TOKEN`) and is stored by the UI after first load.

**Not on localhost:**

- **Tailscale Serve** (recommended): keep bind loopback, run `argent gateway --tailscale serve`, open `https://<magicdns>/`. If `gateway.auth.allowTailscale` is `true`, identity headers satisfy auth (no token).
- **Tailnet bind**: run `argent gateway --bind tailnet --token "<token>"`, open `http://<tailscale-ip>:18789/`, paste token in dashboard settings.
- **SSH tunnel**: `ssh -N -L 18789:127.0.0.1:18789 user@host` then open `http://127.0.0.1:18789/?token=...` from `argent dashboard`.
...
1. Install ArgentOS on the new machine.
2. Copy `$ARGENTOS_STATE_DIR` (default: `~/.argentos`) from the old machine.
3. Copy your workspace (default: `~/.argentos/workspace`).
4. Run `argent doctor` and restart the Gateway service.
...
under `~/.argentos/` (for example `~/.argentos/agents/<agentId>/sessions/`).

Related: [Migrating](/install/migrating), [Where things live on disk](/help/faq#where-does-argent-store-its-data),
...
### I cant access docs.argentos.ai SSL error What now

Some Comcast/Xfinity connections incorrectly block `docs.argentos.ai` via Xfinity
Advanced Security. Disable it or allowlist `docs.argentos.ai`, then retry. More
detail: [Troubleshooting](/help/troubleshooting#docsargentosai-shows-an-ssl-error-comcastxfinity).
Please help us unblock it by reporting here: https://spa.xfinity.com/check_url_status.

If you still can't reach the site, the docs are mirrored on GitHub:
https://github.com/ArgentAIOS/argentos/tree/main/docs
...
```bash
curl -fsSL --proto '=https' --tlsv1.2 https://argentos.ai/install.sh | bash -s -- --beta
```

```bash
curl -fsSL --proto '=https' --tlsv1.2 https://argentos.ai/install.sh | bash -s -- --install-method git
```
...
```bash
curl -fsSL https://argentos.ai/install.sh | bash -s -- --verbose
```

Beta install with verbose:

```bash
curl -fsSL https://argentos.ai/install.sh | bash -s -- --beta --verbose
```

For a hackable (git) install:

```bash
curl -fsSL https://argentos.ai/install.sh | bash -s -- --install-method git --verbose
```

More options: [Installer flags](/install/installer).

### Windows install says git not found or argent not recognized
...
**2) argent is not recognized after install**
...
### How do I install ArgentOS on Linux
...
### How do I install ArgentOS on a VPS

Any Linux VPS works. Install on the server, then use SSH/Tailscale to reach the Gateway.

Guides: [exe.dev](/platforms/exe-dev), [Hetzner](/platforms/hetzner), [Railway](/railway).
...
### Can I ask ArgentOS to update itself
...
```bash
argent update
argent update status
argent update --channel stable|beta|dev
argent update --tag <dist-tag|version>
...
`argent onboard` is the recommended setup path. In **local mode** it walks you through:
...
No. You can run ArgentOS with **API keys** (Anthropic/OpenAI/others) or with
...
`claude setup-token` generates a **token string** via the Claude Code CLI (it is not available in the web console). You can run it on **any machine**. Choose **Anthropic token (paste setup-token)** in the wizard or paste it with `argent models auth paste-token --provider anthropic`. The token is stored as an auth profile for the **anthropic** provider and used like an API key (no auto-refresh). More detail: [OAuth](/concepts/oauth).
...
Copy the token it prints, then choose **Anthropic token (paste setup-token)** in the wizard. If you want to run it on the gateway host, use `argent models auth setup-token --provider anthropic`. If you ran `claude setup-token` elsewhere, paste it on the gateway host with `argent models auth paste-token --provider anthropic`. See [Anthropic](/providers/anthropic).

### Do you support Claude subscription auth (Claude Pro/Max)

Yes - via **setup-token**. ArgentOS no longer reuses Claude Code CLI OAuth tokens; use a setup-token or an Anthropic API key. Generate the token anywhere and paste it on the gateway host. See [Anthropic](/providers/anthropic) and [OAuth](/concepts/oauth).
...
Tip: set a **fallback model** so ArgentOS can keep replying while a provider is rate-limited.
...
ArgentOS supports **OpenAI Code (Codex)** via OAuth (ChatGPT sign-in). The wizard can run the OAuth flow and will set the default model to `openai-codex/gpt-5.2` when appropriate. See [Model providers](/concepts/model-providers) and [Wizard](/start/wizard).

### Do you support OpenAI subscription auth Codex OAuth

Yes. ArgentOS fully supports **OpenAI Code (Codex) subscription OAuth**. The onboarding wizard
...
Gemini CLI uses a **plugin auth flow**, not a client id or secret in `argent.json`.

Steps:

1. Enable the plugin: `argent plugins enable google-gemini-cli-auth`
2. Login: `argent models auth login --provider google-gemini-cli --set-default`

This stores OAuth tokens in auth profiles on the gateway host. Details: [Model providers](/concepts/model-providers).

### Is a local model OK for casual chats

Usually no. ArgentOS needs large context + strong safety; small cards truncate and leak. If you must, run the **largest** MiniMax M2.1 build you can locally (LM Studio) and see [/gateway/local-models](/gateway/local-models). Smaller/quantized models increase prompt-injection risk - see [Security](/gateway/security).
...
No. ArgentOS runs on macOS or Linux (Windows via WSL2). A Mac mini is optional - some people
...
### If I buy a Mac mini to run ArgentOS can I connect it to my MacBook Pro
...
- Use `argent nodes status` / `argent nodes list` to see it.
...
- DM your bot, then run `argent logs --follow` and read `from.id`.
...
### Can multiple people use one WhatsApp number with different ArgentOS instances
...
**ArgentOS-specific note:** WhatsApp/Telegram/Slack/Mattermost (plugin)/Discord all work fine from a VPS. The only real trade-off is **headless browser** vs a visible window. See [Browser](/tools/browser).

**Recommended default:** VPS if you had gateway disconnects before. Local is great when you're actively using the Mac and want local file access or UI automation with a visible browser.

### How important is it to run ArgentOS on a dedicated machine
...
ArgentOS is lightweight. For a basic Gateway + one chat channel:
...
### Can I run ArgentOS in a VM and what are the requirements
...
### What is ArgentOS in one paragraph

ArgentOS is a personal AI assistant you run on your own devices. It replies on the messaging surfaces you already use (WhatsApp, Telegram, Slack, Mattermost (plugin), Discord, Google Chat, Signal, iMessage, WebChat) and can also do voice + a live Canvas on supported platforms. The **Gateway** is the always-on control plane; the assistant is the product.

### What's the value proposition

ArgentOS is not "just a Claude wrapper." It's a **local-first control plane** that lets you run a
...
### What are the top five everyday use cases for ArgentOS
...
### Can ArgentOS help with lead gen outreach ads and blogs for a SaaS
...
ArgentOS draft and you approve.

Docs: [Security](/gateway/security).

### What are the advantages vs Claude Code for web development

ArgentOS is a **personal assistant** and coordination layer, not an IDE replacement. Use
Claude Code or Codex for the fastest direct coding loop inside a repo. Use ArgentOS when you
...
Showcase: https://argentos.ai/showcase

## Skills and automation

### How do I customize skills without keeping the repo dirty

Use managed overrides instead of editing the repo copy. Put your changes in `~/.argentos/skills/<name>/SKILL.md` (or add a folder via `skills.load.extraDirs` in `~/.argentos/argent.json`). Precedence is `<workspace>/skills` > `~/.argentos/skills` > bundled, so managed overrides win without touching git. Only upstream-worthy edits should live in the repo and go out as PRs.

### Can I load skills from a custom folder

Yes. Add extra directories via `skills.load.extraDirs` in `~/.argentos/argent.json` (lowest precedence). Default precedence remains: `<workspace>/skills` → `~/.argentos/skills` → bundled → `skills.load.extraDirs`. `clawhub` installs into `./skills` by default, which ArgentOS treats as `<workspace>/skills`.
...
- Confirm cron is enabled (`cron.enabled`) and `ARGENTOS_SKIP_CRON` is not set.
...
```bash
argent cron run <jobId> --force
argent cron runs --id <jobId> --limit 50
```
...
### Can ArgentOS run tasks on a schedule or continuously in the background
...
Not directly. macOS skills are gated by `metadata.argent.os` plus required binaries, and skills only appear in the system prompt when they are eligible on the **Gateway host**. On Linux, `darwin`-only skills (like `apple-notes`, `apple-reminders`, `things-mac`) will not load unless you override the gating.

You have three supported patterns:

**Option A - run the Gateway on a Mac (simplest).**
Run the Gateway where the macOS binaries exist, then connect from Linux in [remote mode](#how-do-i-run-argent-in-remote-mode-client-connects-to-a-gateway-elsewhere) or over Tailscale. The skills load normally because the Gateway host is macOS.

**Option B - use a macOS node (no SSH).**
Run the Gateway on Linux, pair a macOS node (menubar app), and set **Node Run Commands** to "Always Ask" or "Always Allow" on the Mac. ArgentOS can treat macOS-only skills as eligible when the required binaries exist on the node. The agent runs those skills via the `nodes` tool. If you choose "Always Ask", approving "Always Allow" in the prompt adds that command to the allowlist.
...
3. Override the skill metadata (workspace or `~/.argentos/skills`) to allow Linux:
   ```markdown
   ---
   name: apple-notes
   description: Manage Apple Notes via the memo CLI on macOS.
   metadata: { "argent": { "os": ["darwin", "linux"], "requires": { "bins": ["memo"] } } }
   ---
   ```
...
ClawHub installs into `./skills` under your current directory (or falls back to your configured ArgentOS workspace); ArgentOS treats that as `<workspace>/skills` on the next session. For shared skills across agents, place them in `~/.argentos/skills/<name>/SKILL.md`. Some skills expect binaries installed via Homebrew; on Linux that means Linuxbrew (see the Homebrew Linux FAQ entry above). See [Skills](/tools/skills) and [ClawHub](/tools/clawhub).
...
```bash
argent browser extension install
argent browser extension path
```
...
- Persist `/home/node` with `ARGENTOS_HOME_VOLUME` so caches survive.
- Bake system deps into the image with `ARGENTOS_DOCKER_APT_PACKAGES`.
...
ArgentOS memory is just Markdown files in the agent workspace:

- Daily notes in `memory/YYYY-MM-DD.md`
- Curated long-term notes in `MEMORY.md` (main/private sessions only)

ArgentOS also runs a **silent pre-compaction memory flush** to remind the model
...
If you don't set a provider explicitly, ArgentOS auto-selects a provider when it
can resolve an API key (auth profiles, `models.providers.*.apiKey`, or env vars).
It prefers OpenAI if an OpenAI key resolves, otherwise Gemini if a Gemini key
resolves. If neither key is available, memory search stays disabled until you
configure it. If you have a local model path configured and present, ArgentOS
prefers `local`.

If you'd rather stay local, set `memorySearch.provider = "local"` or
`memorySearch.provider = "ollama"` (and optionally
`memorySearch.fallback = "none"`). If you want Gemini embeddings, set
`memorySearch.provider = "gemini"` and provide `GEMINI_API_KEY` (or
`memorySearch.remote.apiKey`). We support **OpenAI, Gemini, Ollama, or local** embedding
...
### Is all data used with ArgentOS saved locally

No - **ArgentOS's state is local**, but **external services still see what you send them**.

- **Local by default:** sessions, memory files, config, and workspace live on the Gateway host
  (`~/.argentos` + your workspace directory).
...
### Where does ArgentOS store its data

Everything lives under `$ARGENTOS_STATE_DIR` (default: `~/.argentos`):

| Path                                                            | Purpose                                                      |
| --------------------------------------------------------------- | ------------------------------------------------------------ |
| `$ARGENTOS_STATE_DIR/argent.json`                               | Main config (JSON5)                                          |
| `$ARGENTOS_STATE_DIR/credentials/oauth.json`                    | Legacy OAuth import (copied into auth profiles on first use) |
| `$ARGENTOS_STATE_DIR/agents/<agentId>/agent/auth-profiles.json` | Auth profiles (OAuth + API keys)                             |
| `$ARGENTOS_STATE_DIR/agents/<agentId>/agent/auth.json`          | Runtime auth cache (managed automatically)                   |
| `$ARGENTOS_STATE_DIR/credentials/`                              | Provider state (e.g. `whatsapp/<accountId>/creds.json`)      |
| `$ARGENTOS_STATE_DIR/agents/`                                   | Per-agent state (agentDir + sessions)                        |
| `$ARGENTOS_STATE_DIR/agents/<agentId>/sessions/`                | Conversation history & state (per agent)                     |
| `$ARGENTOS_STATE_DIR/agents/<agentId>/sessions/sessions.json`   | Session metadata (per agent)                                 |

Legacy single-agent path: `~/.argentos/agent/*` (migrated by `argent doctor`).

Your **workspace** (AGENTS.md, memory files, skills, etc.) is separate and configured via `agents.defaults.workspace` (default: `~/.argentos/workspace`).

### Where should AGENTSmd SOULmd USERmd MEMORYmd live

These files live in the **agent workspace**, not `~/.argentos`.

- **Workspace (per agent)**: `AGENTS.md`, `SOUL.md`, `IDENTITY.md`, `USER.md`,
  `MEMORY.md` (or `memory.md`), `memory/YYYY-MM-DD.md`, optional `HEARTBEAT.md`.
- **State dir (`~/.argentos`)**: config, credentials, auth profiles, sessions, logs,
  and shared skills (`~/.argentos/skills`).

Default workspace is `~/.argentos/workspace`, configurable via:

```json5
{
  agents: { defaults: { workspace: "~/.argentos/workspace" } },
}
```
...
Do **not** commit anything under `~/.argentos` (credentials, sessions, tokens).
If you need a full restore, back up both the workspace and the state directory
separately (see the migration question above).

Docs: [Agent workspace](/concepts/agent-workspace).

### How do I completely uninstall ArgentOS
...
`workspace` to the repo root. The ArgentOS repo is just source code; keep the
...
ArgentOS reads an optional **JSON5** config from `$ARGENTOS_CONFIG_PATH` (default: `~/.argentos/argent.json`):

```
$ARGENTOS_CONFIG_PATH
```

If the file is missing, it uses safe-ish defaults (including a default workspace of `~/.argentos/workspace`).

### I set gatewaybind lan or tailnet and now nothing listens the UI says unauthorized

Non-loopback binds **require auth**. Configure `gateway.auth.mode` + `gateway.auth.token` (or use `ARGENTOS_GATEWAY_TOKEN`).
...
If you **really** want open loopback, remove `gateway.auth` from your config. Doctor can generate a token for you any time: `argent doctor --generate-gateway-token`.
...
key. **Recommended:** run `argent configure --section web` to store it in
...
- Daemons read env vars from `~/.argentos/.env` (or the service environment).
...
### Can the ArgentOS browser run headless
...
5. Approve the node on the Gateway:
   ```bash
   argent nodes pending
   argent nodes approve <requestId>
   ```
...
- Gateway is running: `argent gateway status`
- Gateway health: `argent status`
- Channel health: `argent channels status`
...
### Can two ArgentOS instances talk to each other local VPS
...
`argent agent --message ... --deliver`, targeting a chat where the other bot
...
```bash
argent agent --message "Hello from local bot" --deliver --channel telegram --reply-to <chat-id>
```
...
- Restore from backup (git or a copied `~/.argentos/argent.json`).
- If you have no backup, re-run `argent doctor` and reconfigure channels/models.
- If this was unexpected, file a bug and include your last known config or any backup.
- A local coding agent can often reconstruct a working config from logs or history.

Avoid it:

- Use `argent config set` for small changes.
- Use `argent configure` for interactive edits.
...
```bash
argent gateway --tailscale serve
```
...
### How does ArgentOS load environment variables

ArgentOS reads env vars from the parent process (shell, launchd/systemd, CI, etc.) and additionally loads:

- `.env` from the current working directory
- a global fallback `.env` from `~/.argentos/.env` (aka `$ARGENTOS_STATE_DIR/.env`)
...
1. Put the missing keys in `~/.argentos/.env` so they're picked up even when the service doesn't inherit your shell env.
...
`ARGENTOS_LOAD_SHELL_ENV=1`, `ARGENTOS_SHELL_ENV_TIMEOUT_MS=15000`.

### I set COPILOTGITHUBTOKEN but models status shows Shell env off Why

`argent models status` reports whether **shell env import** is enabled. "Shell env: off"
does **not** mean your env vars are missing - it just means ArgentOS won't load
your login shell automatically.

If the Gateway runs as a service (launchd/systemd), it won't inherit your shell
environment. Fix by doing one of these:

1. Put the token in `~/.argentos/.env`:
   ```
...
### Is there a way to make a team of ArgentOS instances one CEO and many agents
...
### How do I completely reset ArgentOS but keep it installed
...
```bash
argent reset --scope full --yes --non-interactive
```
...
- If you used profiles (`--profile` / `ARGENTOS_PROFILE`), reset each state dir (defaults are `~/.argentos-<profile>`).
- Dev reset: `argent gateway --dev --reset` (dev-only; wipes dev config + credentials + sessions + workspace).
...
headers like `# Heading`), ArgentOS skips the heartbeat run to save API calls.
...
No. ArgentOS runs on **your own account**, so if you're in the group, ArgentOS can see it.
...
```bash
argent directory groups list --channel whatsapp
```

Docs: [WhatsApp](/channels/whatsapp), [Directory](/cli/directory), [Logs](/cli/logs).

### Why doesnt ArgentOS reply in a group
...
- **Disk growth:** sessions + transcripts live under `~/.argentos/agents/<agentId>/sessions/`.
...
- Use `argent doctor` to spot stray workspaces and profile mismatches.
...
ArgentOS's default model is whatever you set as:

```
agents.defaults.model.primary
```

Models are referenced as `provider/model` (example: `anthropic/claude-opus-4-5`). If you omit the provider, ArgentOS currently assumes `anthropic` as a temporary deprecation fallback - but you should still **explicitly** set `provider/model`.
...
- `argent models set ...` (updates just model config)
- `argent configure --section models` (interactive)
- edit `agents.defaults.model` in `~/.argentos/argent.json`

Avoid `config.apply` with a partial object unless you intend to replace the whole config.
If you did overwrite config, restore from backup or re-run `argent doctor` to repair.

Docs: [Models](/concepts/models), [Configure](/cli/configure), [Config](/cli/config), [Doctor](/gateway/doctor).

### What do ArgentOS, Flawd, and Krill use for models

- **ArgentOS + Flawd:** Anthropic Opus (`anthropic/claude-opus-4-5`) - see [Anthropic](/providers/anthropic).
...
Yes. ArgentOS ships a few default shorthands (only applied when the model exists in `agents.defaults.models`):
...
```
~/.argentos/agents/<agentId>/agent/auth-profiles.json
```

Fix options:

- Run `argent agents add <id>` and configure auth during the wizard.
...
Cooldowns apply to failing profiles (exponential backoff), so ArgentOS can keep responding even when a provider is rate-limited or temporarily failing.
...
- **Confirm where auth profiles live** (new vs legacy paths)
  - Current: `~/.argentos/agents/<agentId>/agent/auth-profiles.json`
  - Legacy: `~/.argentos/agent/*` (migrated by `argent doctor`)
- **Confirm your env var is loaded by the Gateway**
  - If you set `ANTHROPIC_API_KEY` in your shell but run the Gateway via systemd/launchd, it may not inherit it. Put it in `~/.argentos/.env` or enable `env.shellEnv`.
- **Make sure you're editing the correct agent**
  - Multi-agent setups mean there can be multiple `auth-profiles.json` files.
- **Sanity-check model/auth status**
  - Use `argent models status` to see configured models and whether providers are authenticated.
...
- **Use a setup-token**
  - Run `claude setup-token`, then paste it with `argent models auth setup-token --provider anthropic`.
  - If the token was created on another machine, use `argent models auth paste-token --provider anthropic`.
- **If you want to use an API key instead**
  - Put `ANTHROPIC_API_KEY` in `~/.argentos/.env` on the **gateway host**.
...
If your model config includes Google Gemini as a fallback (or you switched to a Gemini shorthand), ArgentOS will try it during model fallback. If you haven't configured Google credentials, you'll see `No API key found for provider "google"`.
...
Fix: ArgentOS now strips unsigned thinking blocks for Google Antigravity Claude. If it still appears, start a **new session** or set `/thinking off` for that agent.
...
ArgentOS uses provider-prefixed IDs like:
...
ArgentOS may temporarily skip a profile if it's in a short **cooldown** (rate limits/timeouts/auth failures) or a longer **disabled** state (billing/insufficient credits). To inspect this, run `argent models status --json` and check `auth.unusableProfiles`. Tuning: `auth.cooldowns.billingBackoffHours*`.
...
argent models auth order set --provider anthropic anthropic:default

# Or set an explicit order (fallback within provider)
argent models auth order set --provider anthropic anthropic:work anthropic:default
...
```bash
argent models auth order set --provider anthropic --agent main anthropic:default
```

### OAuth vs API key whats the difference

ArgentOS supports both:
...
```
--port > ARGENTOS_GATEWAY_PORT > gateway.port > default 18789
```

### Why does argent gateway status say Runtime running but RPC probe failed

Because "running" is the **supervisor's** view (launchd/systemd/schtasks). The RPC probe is the CLI actually connecting to the gateway WebSocket and calling `status`.

Use `argent gateway status` and trust these lines:

- `Probe target:` (the URL the probe actually used)
- `Listening:` (what's actually bound on the port)
- `Last gateway error:` (common root cause when the process is alive but the port isn't listening)

### Why does argent gateway status show Config cli and Config service different

You're editing one config file while the service is running another (often a `--profile` / `ARGENTOS_STATE_DIR` mismatch).

Fix:

```bash
argent gateway install --force
```
...
ArgentOS enforces a runtime lock by binding the WebSocket listener immediately on startup (default `ws://127.0.0.1:18789`). If the bind fails with `EADDRINUSE`, it throws `GatewayLockError` indicating another instance is already listening.

Fix: stop the other instance, free the port, or run with `argent gateway --port <port>`.

### How do I run ArgentOS in remote mode client connects to a Gateway elsewhere
...
- `argent gateway` only starts when `gateway.mode` is `local` (or you pass the override flag).
...
- The Control UI stores the token in browser localStorage key `argent.control.settings.v1`.
- The UI can import `?token=...` (and/or `?password=...`) once, then strips it from the URL.

Fix:

- Fastest: `argent dashboard` (prints + copies tokenized link, tries to open; shows SSH hint if headless).
- If you don't have a token yet: `argent doctor --generate-gateway-token`.
- If remote, tunnel first: `ssh -N -L 18789:127.0.0.1:18789 user@host` then open `http://127.0.0.1:18789/?token=...`.
- Set `gateway.auth.token` (or `ARGENTOS_GATEWAY_TOKEN`) on the gateway host.
- In the Control UI settings, paste the same token (or refresh with a one-time `?token=...` link).
- Still stuck? Run `argent status --all` and follow [Troubleshooting](/gateway/troubleshooting). See [Dashboard](/web/dashboard) for auth details.
...
- `ARGENTOS_CONFIG_PATH` (per-instance config)
- `ARGENTOS_STATE_DIR` (per-instance state)
- `agents.defaults.workspace` (workspace isolation)
- `gateway.port` (unique ports)

Quick setup (recommended):

- Use `argent --profile <name> …` per instance (auto-creates `~/.argentos-<name>`).
- Set a unique `gateway.port` in each profile config (or pass `--port` for manual runs).
- Install a per-profile service: `argent --profile <name> gateway install`.

Profiles also suffix service names (`bot.molt.<profile>`; legacy `com.argentos.*`, `argent-gateway-<profile>.service`, `ArgentOS Gateway (<profile>)`).
...
```
argent tui --url ws://<host>:18789 --token <token>
```
...
```
/tmp/argentos/argent-YYYY-MM-DD.log
```
...
- macOS: `$ARGENTOS_STATE_DIR/logs/gateway.log` and `gateway.err.log` (default: `~/.argentos/logs/...`; profiles use `~/.argentos-<profile>/logs/...`)
- Linux: `journalctl --user -u argent-gateway[-<profile>].service -n 200 --no-pager`
- Windows: `schtasks /Query /TN "ArgentOS Gateway (<profile>)" /V /FO LIST`
...
If you run the gateway manually, `argent gateway --force` can reclaim the port. See [Gateway](/gateway).

### I closed my terminal on Windows how do I restart ArgentOS
...
1. Is the Gateway running? `argent gateway status`
2. Is the Gateway healthy? `argent status`
3. Does the UI have the right token? `argent dashboard`
...
```bash
argent channels status
argent channels logs --channel telegram
```
...
### ELI5 argent gateway restart vs argent gateway

- `argent gateway restart`: restarts the **background service** (launchd/systemd).
- `argent gateway`: runs the gateway **in the foreground** for this terminal session.

If you installed the service, use the gateway commands. Use `argent gateway` when
...
Outbound attachments from the agent must include a `MEDIA:<path-or-url>` line (on its own line). See [ArgentOS assistant setup](/start/argent) and [Agent send](/tools/agent-send).

CLI sending:

```bash
argent message send --target +15555550123 --message "Here you go" --media /path/to/file.png
```
...
### Is it safe to expose ArgentOS to inbound DMs

Treat inbound DMs as untrusted input. Defaults are designed to reduce risk:

- Default behavior on DM-capable channels is **pairing**:
  - Unknown senders receive a pairing code; the bot does not process their message.
  - Approve with: `argent pairing approve <channel> <code>`
  - Pending requests are capped at **3 per channel**; check `argent pairing list <channel>` if a code didn't arrive.
- Opening DMs publicly requires explicit opt-in (`dmPolicy: "open"` and allowlist `"*"`).

Run `argent doctor` to surface risky DM policies.
...
No. Default WhatsApp DM policy is **pairing**. Unknown senders only get a pairing code and their message is **not processed**. ArgentOS only replies to chats it receives or to explicit sends you trigger.

Approve pairing with:

```bash
argent pairing approve whatsapp <code>
```

List pending requests:

```bash
argent pairing list whatsapp
```
...
ArgentOS blocks **cross-provider** messaging by default. If a tool call is bound
...
**A:** In ArgentOS, credentials and model selection are separate. Setting `ANTHROPIC_API_KEY` (or storing an Anthropic API key in auth profiles) enables authentication, but the actual default model is whatever you configure in `agents.defaults.model.primary` (for example, `anthropic/claude-sonnet-4-5` or `anthropic/claude-opus-4-5`). If you see `No credentials found for profile "anthropic:default"`, it means the Gateway couldn't find Anthropic credentials in the expected `auth-profiles.json` for the agent that's running.

---

Still stuck? Ask in [Discord](https://discord.com/invite/clawd) or open a [GitHub discussion](https://github.com/ArgentAIOS/argentos/discussions).
