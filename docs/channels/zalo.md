...
- Install via CLI: `argent plugins install @argentos/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `argent plugins install ./extensions/zalo`
   - From npm (if published): `argent plugins install @argentos/zalo`
...
- Approve via:
  - `argent pairing list zalo`
  - `argent pairing approve zalo <CODE>`
...
- Example: `argent message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `argent channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `argent logs --follow`
