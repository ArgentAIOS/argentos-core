---
summary: "Use Qwen OAuth (free tier) in ArgentOS"
read_when:
  - You want to use Qwen with ArgentOS
...
If you already logged in with the Qwen Code CLI, ArgentOS will sync credentials
