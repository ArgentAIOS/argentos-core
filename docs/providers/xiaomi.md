---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with ArgentOS"
read_when:
  - You want Xiaomi MiMo models in ArgentOS
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). ArgentOS uses
