---
summary: "Use Synthetic's Anthropic-compatible API in ArgentOS"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. ArgentOS registers it as the
...
Note: ArgentOS's Anthropic client appends `/v1` to the base URL, so use
