...
@click.pass_context
def file_list(ctx: click.Context, folder_id: str | None, limit: int) -> None:
    _set_command(ctx, "file.list")
    require_mode(ctx, "file.list")
    _emit_success(ctx, "file.list", file_list_result(ctx.obj, folder_id=folder_id, limit=limit))
...
@click.argument("file_id", required=False)
@click.pass_context
def file_download(ctx: click.Context, file_id: str | None) -> None:
...
def collaboration_group() -> None:
    pass


@collaboration_group.command("list")
@click.option("--folder-id", default=None)
@click.pass_context
def collaboration_list(ctx: click.Context, folder_id: str | None) -> None:
...
@click.argument("file_id", required=False)
@click.pass_context
def metadata_get(ctx: click.Context, file_id: str | None) -> None:
