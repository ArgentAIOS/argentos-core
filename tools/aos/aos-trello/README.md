...
- `card.create_draft` and `card.update_draft` are scaffolded write paths only.

The connector uses the Trello REST API and keeps setup, health, config, doctor,
and capabilities outputs truthful about what is live and what is still scaffolded.
