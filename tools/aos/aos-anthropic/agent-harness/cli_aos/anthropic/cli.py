...
from .runtime import (
    ...
    doctor_snapshot,
    health_snapshot,
    message_create_result,
    message_stream_result,
    model_list_result,
)
...
def message_create(
    ...
    _set_command(ctx, "message.create")
    require_mode(ctx, "message.create")
    _emit_success(
        ctx,
        "message.create",
        message_create_result(
...
def message_stream(
    ...
    _set_command(ctx, "message.stream")
    require_mode(ctx, "message.stream")
    _emit_success(
        ctx,
        "message.stream",
        message_stream_result(
