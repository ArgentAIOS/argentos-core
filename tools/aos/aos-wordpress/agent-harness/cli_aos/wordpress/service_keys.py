...
TOOL_SCOPE_KEYS = ("aos-wordpress", "wordpress")
...
def _candidate_keys(variable: str) -> tuple[str, ...]:
    suffix = variable.removeprefix("AOS_").removeprefix("WORDPRESS_").lower()
    keys = [variable, variable.lower(), suffix]
    aliases = {
        "WORDPRESS_BASE_URL": ("base_url", "site_url", "url"),
        "AOS_WORDPRESS_BASE_URL": ("base_url", "site_url", "url"),
        "WORDPRESS_USERNAME": ("username", "user", "login"),
        "AOS_WORDPRESS_USERNAME": ("username", "user", "login"),
        "WORDPRESS_APPLICATION_PASSWORD": ("application_password", "app_password", "password"),
        "AOS_WORDPRESS_APPLICATION_PASSWORD": ("application_password", "app_password", "password"),
    }
