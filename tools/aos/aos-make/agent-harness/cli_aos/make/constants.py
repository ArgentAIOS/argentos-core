...
AUTH_DESCRIPTOR = {
    ...
    "interactive_setup": [
        ...
        f"Add {MAKE_API_URL_ENV} and {MAKE_API_KEY_ENV} in API Keys.",
        f"Set {MAKE_WEBHOOK_BASE_URL_ENV} if you need a stable public base for trigger execution callbacks.",
        f"Set {MAKE_ORGANIZATION_NAME_ENV}, {MAKE_TEAM_NAME_ENV}, {MAKE_SCENARIO_NAME_ENV}, and {MAKE_CONNECTION_NAME_ENV} to preview the selected scope.",
