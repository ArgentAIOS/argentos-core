...
TOOL_SCOPE_KEYS = ("aos-teams", "teams", "microsoft-teams", "microsoft_teams")
...
def _candidate_keys(variable: str) -> tuple[str, ...]:
    suffix = variable.removeprefix("TEAMS_").lower()
    keys = [variable, variable.lower(), suffix]
    aliases = {
        "TEAMS_TENANT_ID": ("tenant_id", "tenant"),
        "TEAMS_CLIENT_ID": ("client_id", "app_id"),
        "TEAMS_CLIENT_SECRET": ("client_secret", "secret"),
        "TEAMS_TEAM_ID": ("team_id", "team"),
        "TEAMS_CHANNEL_ID": ("channel_id", "channel"),
        "TEAMS_CHAT_ID": ("chat_id", "chat"),
        "TEAMS_USER_ID": ("user_id", "user"),
        "TEAMS_GRAPH_BASE_URL": ("graph_base_url", "base_url", "api_url"),
        "TEAMS_TOKEN_URL": ("token_url",),
        "TEAMS_HTTP_TIMEOUT_SECONDS": ("timeout_seconds", "http_timeout_seconds"),
        "TEAMS_MEETING_SUBJECT": ("meeting_subject", "subject"),
        "TEAMS_START_TIME": ("start_time",),
        "TEAMS_END_TIME": ("end_time",),
    }
