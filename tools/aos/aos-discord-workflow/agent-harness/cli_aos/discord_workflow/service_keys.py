...
TOOL_SCOPE_KEYS = ("aos-discord-workflow", "discord-workflow", "discord_workflow", "discord")
...
def _candidate_keys(variable: str) -> tuple[str, ...]:
    suffix = variable.removeprefix("DISCORD_").lower()
    keys = [variable, variable.lower(), suffix]
    aliases = {
        "DISCORD_BOT_TOKEN": ("bot_token", "token"),
        "DISCORD_WEBHOOK_URL": ("webhook_url", "webhook"),
        "DISCORD_API_BASE_URL": ("api_base_url", "base_url", "api_url"),
        "DISCORD_GUILD_ID": ("guild_id", "guild"),
        "DISCORD_CHANNEL_ID": ("channel_id", "channel"),
        "DISCORD_MESSAGE_ID": ("message_id", "message"),
        "DISCORD_ROLE_ID": ("role_id", "role"),
        "DISCORD_MEMBER_ID": ("member_id", "member"),
        "DISCORD_CONTENT": ("content", "text"),
        "DISCORD_EMBED_JSON": ("embed_json", "embed"),
        "DISCORD_THREAD_NAME": ("thread_name",),
        "DISCORD_CHANNEL_NAME": ("channel_name", "name"),
