...
def success(*, command: str, mode: str, started: float, version: str, data: dict[str, Any]) -> dict[str, Any]:
    return {"ok": True, "tool": "aos-callscrub", "command": command, "data": data, "meta": _meta(mode=mode, started=started, version=version)}


def failure(*, command: str, mode: str, started: float, version: str, error: dict[str, Any]) -> dict[str, Any]:
    return {"ok": False, "tool": "aos-callscrub", "command": command, "error": error, "meta": _meta(mode=mode, started=started, version=version)}
