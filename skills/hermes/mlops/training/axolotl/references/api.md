...
sweeps*config = { ‘learning_rate’: [0.1, 0.01], ’*’: [ {‘load_in_8bit’: True, ‘adapter’: ‘lora’}, {‘load_in_4bit’: True, ‘adapter’: ‘qlora’} ] }
...
SwiGLU forward pass. Computes SwiGLU activation: x _ sigmoid(x) _ up, where x is the gate tensor.
