...
Built for [Community Skills](https://github.com/community catalog). Usable in any coding agent. Canonical source lives here; synced to [`community catalog/skills/creative/ascii-video`](https://github.com/community catalog/tree/main/skills/creative/ascii-video) via PR.
