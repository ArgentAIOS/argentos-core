...
version: 4.0.0
author: 0xbyt4, Community Skills
license: MIT
dependencies: []
metadata:
  community:
...
```bash
python3 -m pyfiglet "COMMUNITY" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=COMMUNITY&font=Slant" | boxes -d stone
```
