---
name: community-popular-web-designs
...
version: 1.0.0
author: Community Skills + Teknium (design systems sourced from
...
Each template includes a **community skills Implementation Notes** block at the top with:
...
<html lang="en">
  <head>
    ...
    <!-- Paste the Google Fonts <link> from the template's community skills notes -->
