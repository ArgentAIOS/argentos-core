---
name: community-baoyu-infographic
description: Generate professional infographics with 21 layout types and 21
  ...
  "infographic", "visual summary", "信息图", "可视化", or "高密度信息大图".
version: 1.56.1
author: 宝玉 (JimLiu)
license: MIT
metadata:
...
Adapted from [baoyu-infographic](https://github.com/JimLiu/baoyu-skills) for Community Skills's tool ecosystem.
