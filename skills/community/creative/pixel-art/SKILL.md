...
description: Convert images into retro pixel art with hardware-accurate palettes
  ...
  the user pick a style before generating.
version: 2.0.0
author: dodo-reach
license: MIT
metadata:
...
```python
import sys
sys.path.insert(0, "/home/teknium/.community/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.community/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — community skills installs package this)
