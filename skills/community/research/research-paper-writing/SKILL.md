---
name: community-research-paper-writing
...
description: End-to-end pipeline for writing ML/AI research papers — from
  ...
  NeurIPS, ICML, ICLR, ACL, AAAI, COLM. Integrates automated experiment
  monitoring, statistical analysis, iterative writing, and citation
  verification.
version: 1.1.0
...
This skill is designed for the community skills. It uses community skills tools, delegation, scheduling, and memory for the full research lifecycle.

### Related Skills

Compose this skill with other community skills for specific phases:
...
| **plan**                        | Phase 0 (Setup): creating structured plans before execution. Writes to `.community/plans/`                     | `skill_view("plan")`                        |
...
### community skills Tools Reference
