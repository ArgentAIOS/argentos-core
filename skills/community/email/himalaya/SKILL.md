...
## community skills Integration Notes
...
To reply non-interactively from community skills, read the original message, compose a reply, and pipe it:
...
**Non-interactive (use this from community skills)** — pipe the message via stdin:
