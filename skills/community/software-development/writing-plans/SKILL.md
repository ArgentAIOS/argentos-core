...
version: 1.1.0
author: Community Skills (adapted from obra/superpowers)
license: MIT
metadata:
  community:
    tags:
...
> **For community skills:** Use subagent-driven-development skill to implement this plan task-by-task.
...
Use community skills tools to understand the project:
