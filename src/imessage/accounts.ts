...
export function listIMessageAccountIds(cfg: ArgentConfig): string[] {
...
export function resolveDefaultIMessageAccountId(cfg: ArgentConfig): string {
...
function mergeIMessageAccountConfig(cfg: ArgentConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: ArgentConfig): ResolvedIMessageAccount[] {
