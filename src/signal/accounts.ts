...
export function listSignalAccountIds(cfg: ArgentConfig): string[] {
...
export function resolveDefaultSignalAccountId(cfg: ArgentConfig): string {
...
function mergeSignalAccountConfig(cfg: ArgentConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: ArgentConfig): ResolvedSignalAccount[] {
