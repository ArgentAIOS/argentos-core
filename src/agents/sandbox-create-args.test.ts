  ...
  it("includes hardening and resource flags", () => {
    ...
    expect(args).toEqual(
      expect.arrayContaining([
        ...
        "argent.sandbox=1",
        "--label",
        "argent.sessionKey=main",
        "--label",
        "argent.createdAtMs=1700000000000",
        "--label",
        "argent.sandboxBrowser=1",
        "--read-only",
        "--tmpfs",
        "/tmp",
        "--network",
