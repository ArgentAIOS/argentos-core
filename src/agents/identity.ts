import type { ArgentConfig, HumanDelayConfig, IdentityConfig } from "../config/config.js";
...
export function resolveAckReaction(cfg: ArgentConfig, agentId: string): string {
...
export function resolveIdentityNamePrefix(cfg: ArgentConfig, agentId: string): string | undefined {
...
export function resolveIdentityName(cfg: ArgentConfig, agentId: string): string | undefined {
...
export function resolveMessagePrefix(
  ...
  return resolveIdentityNamePrefix(cfg, agentId) ?? opts?.fallback ?? "[argent]";
}

/** Helper to extract a channel config value by dynamic key. */
function getChannelConfig(cfg: ArgentConfig, channel: string): Record<string, unknown> | undefined {
