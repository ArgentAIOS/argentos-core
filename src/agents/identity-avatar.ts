...
function resolveAvatarSource(cfg: ArgentConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: ArgentConfig, agentId: string): AgentAvatarResolution {
