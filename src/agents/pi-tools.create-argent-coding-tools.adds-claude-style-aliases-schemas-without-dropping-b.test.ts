...
describe("createArgentCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createArgentCodingTools({
      config,
    ...
    const anthropicTools = createArgentCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createArgentCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createArgentCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
