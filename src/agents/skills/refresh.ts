...
function resolveWatchPaths(workspaceDir: string, config?: ArgentConfig): string[] {
  const paths: string[] = [];
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: ArgentConfig }) {
