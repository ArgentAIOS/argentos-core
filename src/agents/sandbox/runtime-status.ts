...
function resolveMainSessionKeyForSandbox(params: { cfg?: ArgentConfig; agentId: string }): string {
...
export function resolveSandboxRuntimeStatus(params: { cfg?: ArgentConfig; sessionKey?: string }): {
  agentId: string;
  sessionKey: string;
...
export function formatSandboxToolPolicyBlockedMessage(params: {
  ...
  lines.push(
    `- See: ${formatCliCommand(`argent sandbox explain --session ${runtime.sessionKey}`)}`,
  );
