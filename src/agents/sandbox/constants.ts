...
export const DEFAULT_SANDBOX_WORKSPACE_ROOT = path.join(os.homedir(), ".argent", "sandboxes");

export const DEFAULT_SANDBOX_IMAGE = "argent-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "argent-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "argent-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "argent-sandbox-common:bookworm-slim";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "argent-sbx-browser-";
...
const resolvedSandboxStateDir = STATE_DIR ?? path.join(os.homedir(), ".argent");
