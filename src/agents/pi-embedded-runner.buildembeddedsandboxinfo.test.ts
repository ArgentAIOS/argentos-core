...
const _ensureModels = (cfg: ArgentConfig, agentDir: string) =>
  ensureArgentModelsJson(cfg, agentDir) as unknown;
...
describe("buildEmbeddedSandboxInfo", () => {
  ...
  it("maps sandbox context into prompt info", () => {
    const sandbox = {
      ...
      workspaceDir: "/tmp/argent-sandbox",
      agentWorkspaceDir: "/tmp/argent-workspace",
      ...
      browser: {
        ...
        containerName: "argent-sbx-browser-test",
      },
