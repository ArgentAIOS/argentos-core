...
describe("model-selection", () => {
  ...
  describe("selectionDiffersFromConfiguredPrimary", () => {
    it("treats same-provider model changes as explicit overrides", () => {
      expect(
        selectionDiffersFromConfiguredPrimary({
          configPrimary: "anthropic/claude-haiku-4-5",
          provider: "anthropic",
    ...
    it("returns false when selection matches configured primary", () => {
      expect(
        selectionDiffersFromConfiguredPrimary({
          configPrimary: "anthropic/claude-haiku-4-5",
          provider: "anthropic",
    ...
    it("treats missing or malformed primary as explicit override", () => {
      expect(
        selectionDiffersFromConfiguredPrimary({
          configPrimary: "not-a-ref",
          provider: "anthropic",
          model: "claude-opus-4-6",
          defaultProvider: "anthropic",
          defaultModel: "claude-haiku-4-5",
