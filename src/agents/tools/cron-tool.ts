...
- "nudge": Lightweight proactive nudge (isolated sessions only)
  { "kind": "nudge", "text": "<message>", "label": "<optional>" }
- "vipEmailScan": Deterministic VIP email monitor scan (isolated sessions only)
  { "kind": "vipEmailScan", "emitAlerts": true, "maxResults": 20, "lookbackDays": 7, "accounts": ["you@example.com"] }
- "slackSignalScan": Deterministic Slack signal monitor scan (isolated sessions only)
  { "kind": "slackSignalScan", "emitAlerts": true, "createTasks": true, "accountId": "default" }
