...
export function createSessionsSpawnTool(opts?: {
  ...
  return {
    ...
    name: "sessions_spawn",
    description:
      "Spawn a background sub-agent run in an isolated session and announce the result back to the requester chat. Use toolsAllow/toolsDeny for strict per-run capability grants.",
