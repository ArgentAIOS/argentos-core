...
export type TokenCredential = {
   ...
   * Not refreshable by Argent (unlike `type: "oauth"`).
   */
  type: "token";
  provider: string;
  token: string;
...
/** Per-provider usage statistics for provider-wide cooldowns/circuit breakers */
...
export type AuthProfileStore = {
  ...
  /** Usage statistics per provider for provider-wide cooldown/circuit-breaker state */
  providerStats?: Record<string, ProviderUsageStats>;
};
