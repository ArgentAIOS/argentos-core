...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.ARGENT_DEBUG_TELEGRAM_ACCOUNTS)) {
...
export function listTelegramAccountIds(cfg: ArgentConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: ArgentConfig): string {
...
function mergeTelegramAccountConfig(cfg: ArgentConfig, accountId: string): TelegramAccountConfig {
...
export function listEnabledTelegramAccounts(cfg: ArgentConfig): ResolvedTelegramAccount[] {
