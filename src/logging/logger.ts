...
export const DEFAULT_LOG_DIR = "/tmp/argent";
export const DEFAULT_LOG_FILE = path.join(DEFAULT_LOG_DIR, "argent.log"); // legacy single-file path

const LOG_PREFIX = "argent";
...
function resolveSettings(): ResolvedSettings {
  let cfg: ArgentConfig["logging"] | undefined =
