...
function resolveDefaultAccountId(cfg: ArgentConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: ArgentConfig): boolean {
...
export function summarizeBindings(cfg: ArgentConfig, bindings: AgentBinding[]): string[] {
