...
function resolveConfiguredModelRaw(cfg: ArgentConfig): string {
...
function resolveConfiguredModelKeys(cfg: ArgentConfig): string[] {
...
export function applyPrimaryModel(cfg: ArgentConfig, model: string): ArgentConfig {
...
export function applyModelAllowlist(cfg: ArgentConfig, models: string[]): ArgentConfig {
  const defaults = cfg.agents?.defaults;
