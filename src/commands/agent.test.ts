...
async function withTempHome<T>(fn: (home: string) => Promise<T>): Promise<T> {
  return withTempHomeBase(fn, { prefix: "argent-agent-" });
}

function mockConfig(
  home: string,
  storePath: string,
  agentOverrides?: Partial<NonNullable<NonNullable<ArgentConfig["agents"]>["defaults"]>>,
  telegramOverrides?: Partial<NonNullable<ArgentConfig["telegram"]>>,
