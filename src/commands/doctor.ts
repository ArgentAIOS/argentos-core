...
function resolveMode(cfg: ArgentConfig): "local" | "remote" {
...
export async function doctorCommand(
  ...
  let cfg: ArgentConfig = configResult.cfg;
  ...
  if (shouldWriteConfig) {
    ...
    runtime.log(`Run "${formatCliCommand("argent doctor --fix")}" to apply changes.`);
  }
