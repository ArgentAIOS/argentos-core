...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof ArgentConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: ArgentConfig; env: NodeJS.ProcessEnv }): {
  cfg: ArgentConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
