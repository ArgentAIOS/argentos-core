...
function mergeFeishuAccountConfig(cfg: ArgentConfig, accountId: string): FeishuAccountConfig {
...
export function listFeishuAccountIds(cfg: ArgentConfig): string[] {
...
export function resolveDefaultFeishuAccountId(cfg: ArgentConfig): string {
