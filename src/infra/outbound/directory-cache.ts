...
export class DirectoryCache<T> {
  ...
  private lastConfigRef: ArgentConfig | null = null;

  constructor(private readonly ttlMs: number) {}

  get(key: string, cfg: ArgentConfig): T | undefined {
  ...
  set(key: string, value: T, cfg: ArgentConfig): void {
    this.resetIfConfigChanged(cfg);
  ...
  private resetIfConfigChanged(cfg: ArgentConfig): void {
