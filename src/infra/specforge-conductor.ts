...
function buildGuidePrompt(session: SpecforgeGuideSession): string {
  ...
  const executionHandoff = [
    ...
    "- Use Redis-backed family.message/family.inbox for live agent-to-agent coordination.",
    "- Mirror durable decisions, blockers, merge requests, and containment proof to the Threadmaster bus.",
