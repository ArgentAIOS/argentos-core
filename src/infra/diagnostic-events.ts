...
export type DiagnosticMemoryCandidateCapturedEvent = DiagnosticBaseEvent & {
  type: "memory.candidate_captured";
...
export type DiagnosticMemoryCandidatePromotedEvent = DiagnosticBaseEvent & {
...
export type DiagnosticMemoryCandidateExpiredEvent = DiagnosticBaseEvent & {
  type: "memory.candidate_expired";
  count: number;
};
...
export function isDiagnosticsEnabled(config?: ArgentConfig): boolean {
