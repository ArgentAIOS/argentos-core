...
describe("update-startup", () => {
  ...
  beforeEach(async () => {
    ...
    tempDir = await fs.mkdtemp(path.join(os.tmpdir(), "argent-update-check-"));
  ...
  it("logs update hint for npm installs when newer tag exists", async () => {
    const { resolveArgentPackageRoot } = await import("./argent-root.js");
    ...
    vi.mocked(resolveArgentPackageRoot).mockResolvedValue("/opt/argent");
