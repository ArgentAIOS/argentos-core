...
describe("ExecutiveShadowClient integration", () => {
  it("talks to a live argent-execd daemon", async () => {
    ...
    expect(readiness.promotionGates.every((gate) => gate.status === "blocked")).toBe(true);
