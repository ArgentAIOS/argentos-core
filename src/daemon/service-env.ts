...
export function buildServiceEnvironment(params: {
  ...
  return {
    ...
    ARGENT_SERVICE_KIND: GATEWAY_SERVICE_KIND,
...
export function buildNodeServiceEnvironment(params: {
  ...
  return {
    ...
    ARGENT_SYSTEMD_UNIT: resolveNodeSystemdServiceName(),
    ARGENT_WINDOWS_TASK_NAME: resolveNodeWindowsTaskName(),
    ARGENT_TASK_SCRIPT_NAME: NODE_WINDOWS_TASK_SCRIPT_NAME,
    ARGENT_LOG_PREFIX: "node",
    ARGENT_SERVICE_MARKER: NODE_SERVICE_MARKER,
    ARGENT_SERVICE_KIND: NODE_SERVICE_KIND,
    ARGENT_SERVICE_VERSION: VERSION,
  };
}
