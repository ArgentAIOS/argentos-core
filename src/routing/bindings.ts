...
export function listBindings(cfg: ArgentConfig): AgentBinding[] {
  return Array.isArray(cfg.bindings) ? cfg.bindings : [];
}

export function listBoundAccountIds(cfg: ArgentConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: ArgentConfig) {
