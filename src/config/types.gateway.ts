...
export type WideAreaDiscoveryConfig = {
  enabled?: boolean;
  /** Optional unicast DNS-SD domain (e.g. "argent.internal"). */
  domain?: string;
};
...
export type CanvasHostConfig = {
  enabled?: boolean;
  /** Directory to serve (default: ~/.argentos/workspace/canvas). */
  root?: string;
...
export type GatewayControlUiConfig = {
  ...
  enabled?: boolean;
  /** Optional base path prefix for the Control UI (e.g. "/argent"). */
  basePath?: string;
...
export type GatewayRelayConfig = {
  /** Enable outbound relay connection for NAT traversal (default: false). */
  enabled?: boolean;
  /** Relay server WebSocket URL (default: "wss://relay.argentos.ai/gateway"). */
  url?: string;
...
export type GatewayConfig = {
  ...
  /** Outbound relay connection for mobile app NAT traversal. */
