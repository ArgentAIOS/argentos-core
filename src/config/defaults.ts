...
function resolveAnthropicDefaultAuthMode(cfg: ArgentConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: ArgentConfig): ArgentConfig {
...
export function applyTalkApiKey(config: ArgentConfig): ArgentConfig {
...
export function applyModelDefaults(cfg: ArgentConfig): ArgentConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: ArgentConfig): ArgentConfig {
...
export function applyLoggingDefaults(cfg: ArgentConfig): ArgentConfig {
...
export function applyContextPruningDefaults(cfg: ArgentConfig): ArgentConfig {
...
export function applyCompactionDefaults(cfg: ArgentConfig): ArgentConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
