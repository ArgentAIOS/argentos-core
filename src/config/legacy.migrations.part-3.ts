...
export const LEGACY_CONFIG_MIGRATIONS_PART_3: LegacyConfigMigration[] = [
  ...
  {
    id: "remove-alwaysOnLoop",
    describe:
      "Remove deprecated alwaysOnLoop config (loop retired in favor of gateway health checks)",
    apply: (raw, changes) => {
      if (raw.alwaysOnLoop !== undefined) {
        delete raw.alwaysOnLoop;
        changes.push("Removed deprecated config key: alwaysOnLoop.");
      }
    },
  },
];
