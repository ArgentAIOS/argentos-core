...
export type ToolPolicyConfig = {
  allow?: string[];
  /** Tools that are permitted only after operator approval. */
  ask?: string[];
  /**
...
export type GroupToolPolicyConfig = {
  allow?: string[];
  /** Tools that should require operator approval in this group context. */
  ask?: string[];
...
export type AgentToolsConfig = {
  ...
  profile?: ToolProfileId;
  allow?: string[];
  /** Tools that require operator approval before use. */
  ask?: string[];
...
export type MemorySearchConfig = {
  ...
  query?: {
    ...
    hybrid?: {
      ...
      /** Optional Maximal Marginal Relevance re-ranking (default: disabled). */
      mmr?: {
        /** Enable MMR re-ranking. */
        enabled?: boolean;
        /** Relevance/diversity balance: 0 diversity, 1 relevance (default: 0.7). */
        lambda?: number;
      };
      /** Optional temporal decay for recency weighting (default: disabled). */
      temporalDecay?: {
        /** Enable temporal decay weighting. */
        enabled?: boolean;
        /** Half-life in days for score decay (default: 30). */
        halfLifeDays?: number;
      };
    };
  };
...
export type ToolsConfig = {
  ...
  alsoAllow?: string[];
  deny?: string[];
  /** Department-level tool policy overrides keyed by intent department id. */
  departments?: Record<string, ToolPolicyConfig>;
  /** Optional tool policy overrides keyed by provider id or "provider/model". */
  byProvider?: Record<string, ToolPolicyConfig>;
  web?: {
    search?: {
