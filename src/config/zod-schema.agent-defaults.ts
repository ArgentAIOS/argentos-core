  ...
  .object({
    ...
    toolLoopDetection: z
      .object({
        ...
        singleAttemptTools: z.array(z.string()).optional(),
        perToolBudget: z.record(z.string(), z.number().int().nonnegative()).optional(),
      })
      .strict()
      .optional(),
    compaction: z
    ...
    toolSearch: z
      .object({
        ...
        maxDiscovered: z.number().int().min(1).max(50).optional(),
        coreInclude: z.array(z.string()).optional(),
        coreExclude: z.array(z.string()).optional(),
      })
      .optional(),
    ...
    backgroundConcurrency: z.number().int().positive().optional(),
    subagents: z
      .object({
        maxConcurrent: z.number().int().positive().optional(),
      ...
      .object({
        ...
        thresholds: z
          .object({
            ...
            fast: z.number().min(0).max(1).optional(),
    ...
    loadProfile: z
      .object({
        active: z
          .union([z.literal("desktop"), z.literal("balanced-laptop"), z.literal("cool-laptop")])
          .optional(),
        ...
        overrides: z
          .object({
            ...
            contemplation: ContemplationIntervalSchema,
            sis: SisSchema,
            executionWorker: ExecutionWorkerSchema.optional(),
            maxConcurrent: z.number().int().positive().optional(),
            backgroundConcurrency: z.number().int().positive().optional(),
            subagents: z
              .object({
            ...
            dashboard: z
              .object({
                pollingMultiplier: z.number().positive().optional(),
              })
              .strict()
              .optional(),
          })
