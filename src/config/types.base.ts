...
export type SessionConfig = {
  ...
  dmScope?: DmScope;
  /** Channel/guild session scoping (default: "per-channel"). When "main", guild channel
   *  messages collapse into the agent's main session instead of creating side sessions. */
