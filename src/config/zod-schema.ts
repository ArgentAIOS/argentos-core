...
import { IntentSchema } from "./zod-schema.intent.js";
...
const MemoryVaultIngestSchema = z
  .object({
    enabled: z.boolean().optional(),
    interval: z.string().optional(),
    debounceMs: z.number().int().nonnegative().optional(),
...
const MemoryVaultSchema = z
  .object({
    enabled: z.boolean().optional(),
    path: z.string().optional(),
    knowledgeCollection: z.string().optional(),
    ingest: MemoryVaultIngestSchema.optional(),
  })
  .strict();

const MemoryCogneeRetrievalSchema = z
  .object({
    enabled: z.boolean().optional(),
    timeoutMs: z.number().int().positive().optional(),
    triggerOnSufficiencyFail: z.boolean().optional(),
    triggerOnStructuralQuery: z.boolean().optional(),
    searchModes: z
      .array(
        z.union([
          z.literal("SIMILARITY"),
          z.literal("GRAPH_COMPLETION"),
          z.literal("CHUNKS"),
          z.literal("SUMMARIES"),
          z.literal("INSIGHTS"),
        ]),
...
const MemoryCogneeSchema = z
  .object({
    enabled: z.boolean().optional(),
    retrieval: MemoryCogneeRetrievalSchema.optional(),
...
const MemoryMemuSchema = z
  .object({
    llm: MemoryMemuLlmSchema.optional(),
    sanitizer: z
      .object({
        policy: z
          .union([z.literal("log_only"), z.literal("drop"), z.literal("drop_and_alert")])
          .optional(),
      })
      .strict()
      .optional(),
...
const StoredLicenseSchema = z
  .object({
    ...
    cachedStatus: z
      ...
      .optional(),
    cachedTier: z
      .union([z.literal("free"), z.literal("pro"), z.literal("enterprise"), z.literal("custom")])
      .optional(),
    cachedExpiresAt: z.string().optional(),
  })
  .strict()
  .optional();

export const ArgentSchema = z
  .object({
    meta: z
      .object({
      ...
      .object({
        ...
        publicCore: z
          .object({
            ...
            alsoAllowTools: z.array(z.string()).optional(),
            denyTools: z.array(z.string()).optional(),
            allowPlugins: z.array(z.string()).optional(),
            denyPlugins: z.array(z.string()).optional(),
          })
          .strict()
          .optional(),
      })
      ...
      .object({
        ...
        relay: z
          .object({
            ...
            maxReconnectIntervalMs: z.number().int().positive().optional(),
          })
          .strict()
          .optional(),
      })
    ...
    storage: z
      .object({
        backend: z.enum(["sqlite", "dual", "postgres"]).optional(),
        readFrom: z.enum(["sqlite", "postgres"]).optional(),
        writeTo: z.array(z.enum(["sqlite", "postgres"])).optional(),
        postgres: z
          .object({
