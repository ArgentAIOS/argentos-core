...
export function listSlackAccountIds(cfg: ArgentConfig): string[] {
...
export function resolveDefaultSlackAccountId(cfg: ArgentConfig): string {
...
function mergeSlackAccountConfig(cfg: ArgentConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: ArgentConfig): ResolvedSlackAccount[] {
