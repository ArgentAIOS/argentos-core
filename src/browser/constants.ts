export const DEFAULT_ARGENT_BROWSER_ENABLED = true;
export const DEFAULT_BROWSER_EVALUATE_ENABLED = true;
export const DEFAULT_ARGENT_BROWSER_COLOR = "#FF4500";
export const DEFAULT_ARGENT_BROWSER_PROFILE_NAME = "argent";
