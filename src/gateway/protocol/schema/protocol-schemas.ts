...
export const ProtocolSchemas: Record<string, TSchema> = {
  ...
  TalkRealtimeAudioParams: TalkRealtimeAudioParamsSchema,
  TalkRealtimeMarkParams: TalkRealtimeMarkParamsSchema,
  TalkRealtimeToolResultParams: TalkRealtimeToolResultParamsSchema,
  TalkRealtimeStopParams: TalkRealtimeStopParamsSchema,
  ...
  ConnectorsCatalogParams: ConnectorsCatalogParamsSchema,
  ConnectorsCatalogResult: ConnectorsCatalogResultSchema,
  ToolsStatusParams: ToolsStatusParamsSchema,
  ToolStatusEntry: ToolStatusEntrySchema,
  ToolsStatusResult: ToolsStatusResultSchema,
