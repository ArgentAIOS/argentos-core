...
import type {
  ...
  ConnectorsCatalogParamsSchema,
  ConnectorsCatalogResultSchema,
  ModelChoiceSchema,
  ...
  ToolStatusEntrySchema,
  ToolsStatusResultSchema,
...
export type ConnectorsCatalogParams = Static<typeof ConnectorsCatalogParamsSchema>;
export type ConnectorsCatalogResult = Static<typeof ConnectorsCatalogResultSchema>;
export type ToolsStatusParams = Static<typeof ToolsStatusParamsSchema>;
export type ToolStatusEntry = Static<typeof ToolStatusEntrySchema>;
export type ToolsStatusResult = Static<typeof ToolsStatusResultSchema>;
