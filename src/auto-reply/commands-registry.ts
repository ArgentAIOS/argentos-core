...
export function isCommandEnabled(cfg: ArgentConfig, commandKey: string): boolean {
...
function resolveDefaultCommandContext(cfg?: ArgentConfig): {
  provider: string;
  model: string;
} {
...
export function getCommandDetection(_cfg?: ArgentConfig): CommandDetection {
  const commands = getChatCommands();
...
export function maybeResolveTextAlias(raw: string, cfg?: ArgentConfig) {
