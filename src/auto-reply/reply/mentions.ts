...
function resolveMentionPatterns(cfg: ArgentConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: ArgentConfig | undefined, agentId?: string): RegExp[] {
