...
// Growth-oriented: heartbeats are her life loop, not just a ping.
// HEARTBEAT_OK should only be used when HEARTBEAT.md is empty/absent.
export const HEARTBEAT_PROMPT =
  "Heartbeat: Read HEARTBEAT.md (workspace context) and follow your routine. This is your time — engage, learn, create, check in. Do not infer or repeat old tasks from prior chats. Only reply HEARTBEAT_OK if HEARTBEAT.md is empty or has no actionable content.";
