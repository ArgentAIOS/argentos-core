...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@argent", { botUsername: "argent" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@argent args", {
        botUsername: "argent",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "argent" })).toBe(
      "/help@otherbot",
    );
  });
