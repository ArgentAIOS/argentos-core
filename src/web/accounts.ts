...
export function listWhatsAppAuthDirs(cfg: ArgentConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: ArgentConfig): boolean {
  return listWhatsAppAuthDirs(cfg).some((authDir) => hasWebCredsSync(authDir));
}

export function listWhatsAppAccountIds(cfg: ArgentConfig): string[] {
...
export function resolveDefaultWhatsAppAccountId(cfg: ArgentConfig): string {
...
export function resolveWhatsAppAuthDir(params: { cfg: ArgentConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: ArgentConfig): ResolvedWhatsAppAccount[] {
