...
export const A2UI_PATH = "/__argent__/a2ui";

export const CANVAS_HOST_PATH = "/__argent__/canvas";

export const CANVAS_WS_PATH = "/__argent__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.argentCanvasA2UIAction.postMessage(...)
  // - Android: window.argentCanvasA2UIAction.postMessage(...)
  const handlerNames = ["argentCanvasA2UIAction"];
  ...
  globalThis.Argent = globalThis.Argent ?? {};
  globalThis.Argent.postMessage = postToNode;
  globalThis.Argent.sendUserAction = sendUserAction;
  globalThis.argentPostMessage = postToNode;
  globalThis.argentSendUserAction = sendUserAction;
