...
${formatHelpExamples([
  ['argent message send --target +15555550123 --message "Hi"', "Send a text message."],
  [
    'argent message send --target +15555550123 --message "Hi" --media photo.jpg',
  ...
  [
    'argent message react --channel discord --target 123 --message-id 456 --emoji "✅"',
    "React to a message.",
  ],
])}

${theme.muted("Docs:")} ${formatDocsLink("/cli/message", "docs.argent.ai/cli/message")}`,
    )
    .action(() => {
