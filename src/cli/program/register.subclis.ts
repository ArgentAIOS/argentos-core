...
const shouldRegisterPrimaryOnly = (argv: string[]) => {
  if (isTruthyEnvValue(process.env.ARGENT_DISABLE_LAZY_SUBCOMMANDS)) {
    return false;
  }
...
const shouldEagerRegisterSubcommands = (_argv: string[]) => {
  return isTruthyEnvValue(process.env.ARGENT_DISABLE_LAZY_SUBCOMMANDS);
};

const loadConfig = async (): Promise<ArgentConfig> => {
...
const entries: SubCliEntry[] = [
  ...
  {
    name: "cs",
    description: "Command Center - visual dashboard interface",
    register: async (program) => {
      const mod = await import("../cs-cli.js");
      mod.registerCsCli(program);
    },
  },
  {
    name: "daemon",
  ...
  },
  {
    ...
    register: async (program) => {
      const mod = await import("../doc-panel-cli.js");
      mod.registerDocPanelCli(program);
    },
  },
  {
    name: "docs",
  ...
  },
  {
    ...
    register: async (program) => {
      const mod = await import("../extension-cli.js");
      mod.registerExtensionCli(program);
    },
  },
  {
    name: "skills",
