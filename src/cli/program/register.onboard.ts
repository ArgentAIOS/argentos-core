...
export function registerOnboardCommand(program: Command) {
  program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/onboard", "docs.argent.ai/cli/onboard")}\n`,
    )
    .option("--workspace <dir>", "Agent workspace directory (default: ~/.argentos/workspace)")
    ...
    .option("--mistral-api-key <key>", "Mistral API key")
