...
const SANDBOX_EXAMPLES = {
  main: [
    ["argent sandbox list", "List all sandbox containers."],
    ["argent sandbox list --browser", "List only browser containers."],
    ["argent sandbox recreate --all", "Recreate all containers."],
    ["argent sandbox recreate --session main", "Recreate a specific session."],
    ["argent sandbox recreate --agent mybot", "Recreate agent containers."],
    ["argent sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["argent sandbox list", "List all sandbox containers."],
    ["argent sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ["argent sandbox recreate --all", "Recreate all containers."],
    ["argent sandbox recreate --session main", "Recreate a specific session."],
    ["argent sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["argent sandbox recreate --browser --all", "Recreate only browser containers."],
    ["argent sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["argent sandbox explain", "Show effective sandbox config."],
    ["argent sandbox explain --session agent:main:main", "Explain a specific session."],
    ["argent sandbox explain --agent work", "Explain an agent sandbox."],
    ["argent sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.argent.ai/cli/sandbox")}\n`,
    )
    .action(() => {
