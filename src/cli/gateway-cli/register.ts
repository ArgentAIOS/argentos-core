...
export function registerGatewayCli(program: Command) {
  const gateway = addGatewayRunCommand(
    program
      ...
      .addHelpText(
        "after",
        () =>
          `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/gateway", "docs.argent.ai/cli/gateway")}\n`,
      ),
  );
  ...
  gateway
    ...
    .option("--json", "Output JSON", false)
    .action(async function (opts) {
      await runDaemonInstall(mergeGatewayCommandOptions(opts, this));
    });
  ...
  gateway
    ...
    .option("--json", "Output JSON", false)
    .action(async function (opts) {
      await runDaemonUninstall(mergeGatewayCommandOptions(opts, this));
    });
  ...
  gateway
    ...
    .option("--json", "Output JSON", false)
    .action(async function (opts) {
      await runDaemonStart(mergeGatewayCommandOptions(opts, this));
    });
  ...
  gateway
    ...
    .option("--json", "Output JSON", false)
    .action(async function (opts) {
      await runDaemonStop(mergeGatewayCommandOptions(opts, this));
    });
  ...
  gateway
    ...
    .option("--json", "Output JSON", false)
    .action(async function (opts) {
      await runDaemonRestart(mergeGatewayCommandOptions(opts, this));
    });
