const DEFAULT_TAGLINE = "All your chats, one Argent.";
...
const TAGLINES: string[] = [
  ...
  "Automation with purpose: minimal fuss, maximal output.",
  ...
  "Gears turning, commit in—let's ship something mildly responsible.",
...
export function pickTagline(options: TaglineOptions = {}): string {
  ...
  const override = env?.ARGENT_TAGLINE_INDEX;
