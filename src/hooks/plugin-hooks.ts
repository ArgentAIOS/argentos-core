...
import type { ArgentPluginApi } from "../plugins/types.js";
...
function resolveHookDir(api: ArgentPluginApi, dir: string): string {
...
function normalizePluginHookEntry(api: ArgentPluginApi, entry: HookEntry): HookEntry {
  return {
    ...entry,
    hook: {
      ...entry.hook,
