...
public typealias ArgentPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias ArgentPlatformImage = UIImage
#endif

public struct ArgentChatUsageCost: Codable, Hashable, Sendable {
...
public struct ArgentChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: ArgentChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(ArgentChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct ArgentChatMessageContent: Codable, Hashable, Sendable {
...
public struct ArgentChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [ArgentChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: ArgentChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [ArgentChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: ArgentChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(ArgentChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([ArgentChatMessageContent].self, forKey: .content) {
...
public struct ArgentChatHistoryPayload: Codable, Sendable {
...
public struct ArgentSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct ArgentSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [ArgentSessionPreviewItem]
}

public struct ArgentSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [ArgentSessionPreviewEntry]

    public init(ts: Int, previews: [ArgentSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct ArgentChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct ArgentChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct ArgentAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct ArgentChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct ArgentGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct ArgentPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: ArgentPlatformImage?
...
public struct ArgentChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
