...
@MainActor
public struct ArgentChatView: View {
    public enum Style {
        case standard
        case onboarding
    }

    @State private var viewModel: ArgentChatViewModel
    ...
    private var visibleMessages: [ArgentChatMessage] {
        let base: [ArgentChatMessage]
    ...
    private func mergeToolResults(in messages: [ArgentChatMessage]) -> [ArgentChatMessage] {
    ...
    private func isToolResultMessage(_ message: ArgentChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: ArgentChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: ArgentChatMessage) -> String {
