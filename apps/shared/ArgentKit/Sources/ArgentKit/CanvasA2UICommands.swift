...
public enum ArgentCanvasA2UICommand: String, Codable, Sendable {
...
public struct ArgentCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct ArgentCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
