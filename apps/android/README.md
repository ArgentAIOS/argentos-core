## ArgentOS Node (Android) (internal)

Modern Android node app: connects to the **Gateway WebSocket** (`_argent-gw._tcp`) and exposes **Canvas + Chat + Camera**.
...
```bash
pnpm argent gateway --port 18789 --verbose
```
