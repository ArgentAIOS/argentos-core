...
android {
  namespace = "ai.argentos.android"
  compileSdk = 36

  sourceSets {
    getByName("main") {
      assets.srcDir(file("../../shared/ArgentKit/Sources/ArgentKit/Resources"))
    }
  }

  defaultConfig {
    applicationId = "ai.argentos.android"
    minSdk = 31
    targetSdk = 36
  ...
  onVariants { variant ->
    variant.outputs
      ...
      .forEach { output ->
        ...
        val outputFileName = "argentos-${versionName}-${buildType}.apk"
