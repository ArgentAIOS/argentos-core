...
final class ScreenController {
    ...
    /// Callback invoked when an argent:// deep link is tapped in the canvas
    ...
    private static func bundledResourceURL(
        ...
        -> URL?
    {
        let bundle = ArgentKitResources.bundle
...
/// Handles navigation policy to intercept argent:// deep links from canvas
@MainActor
private final class ScreenNavigationDelegate: NSObject, WKNavigationDelegate {
        ...
        decisionHandler: @escaping @MainActor @Sendable (WKNavigationActionPolicy) -> Void)
    {
        ...
        // Intercept argent:// deep links.
        if url.scheme?.lowercased() == "argent" {
