...
final class LocationService: NSObject, CLLocationManagerDelegate {
    ...
    func ensureAuthorization(mode: ArgentLocationMode) async -> CLAuthorizationStatus {
    ...
    func currentLocation(
        params: ArgentLocationGetParams,
    ...
    private static func accuracyValue(_ accuracy: ArgentLocationAccuracy) -> CLLocationAccuracy {
        switch accuracy {
        case .coarse:
