...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.argent", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".argentos/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.argentCommand(
            subcommand: "gateway",
