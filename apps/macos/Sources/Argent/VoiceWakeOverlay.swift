...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.argent", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other Argent windows, but below the system’s pop-up menus.
