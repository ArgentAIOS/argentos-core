...
enum AnthropicAuthMode: Equatable {
    ...
    var shortLabel: String {
        switch self {
        case .oauthFile: "OAuth (Argent token file)"
...
enum AnthropicAuthResolver {
    static func resolve(
        ...
        oauthStatus: ArgentOAuthStore.AnthropicOAuthStatus = ArgentOAuthStore
...
enum AnthropicOAuth {
    private static let logger = Logger(subsystem: "ai.argent", category: "anthropic-oauth")
...
enum ArgentOAuthStore {
    static let oauthFilename = "oauth.json"
    private static let providerKey = "anthropic"
    private static let argentOAuthDirEnv = "ARGENT_OAUTH_DIR"
    ...
    enum AnthropicOAuthStatus: Equatable {
        ...
        var shortDescription: String {
            switch self {
            case .missingFile: "Argent OAuth token file not found"
            case .unreadableFile: "Argent OAuth token file not readable"
            case .invalidJSON: "Argent OAuth token file invalid"
            case .missingProviderEntry: "No Anthropic entry in Argent OAuth token file"
            case .missingTokens: "Anthropic entry missing tokens"
            case .connected: "Argent OAuth credentials found"
            }
        }
    }

    static func oauthDir() -> URL {
        if let override = ProcessInfo.processInfo.environment[self.argentOAuthDirEnv]?
        ...
        let preferred = home.appendingPathComponent(".argent", isDirectory: true)
