...
enum SessionMenuPreviewLoader {
    private static let logger = Logger(subsystem: "ai.argent", category: "SessionPreview")
    ...
    private static func requestPreview(
        keys: [String],
        maxItems: Int) async throws -> ArgentSessionsPreviewPayload
    {
    ...
    private static func snapshot(
        from entry: ArgentSessionPreviewEntry,
    ...
    private static func cache(payload: ArgentSessionsPreviewPayload, maxItems: Int) async {
    ...
    private static func previewItems(
        from payload: ArgentChatHistoryPayload,
        maxItems: Int) -> [SessionPreviewItem]
    {
        let boundedItems = self.normalizeMaxItems(maxItems)
        let raw: [ArgentKit.AnyCodable] = payload.messages ?? []
    ...
    private static func decodeMessages(_ raw: [ArgentKit.AnyCodable]) -> [ArgentChatMessage] {
    ...
    private static func previewText(for message: ArgentChatMessage) -> String? {
    ...
    private static func isToolCall(_ message: ArgentChatMessage) -> Bool {
    ...
    private static func toolNames(for message: ArgentChatMessage) -> [String] {
        var names: [String] = []
    ...
    private static func mediaSummary(for message: ArgentChatMessage) -> String? {
