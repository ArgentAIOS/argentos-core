...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = ArgentConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = ArgentConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = ArgentConfigFile.loadDict()
            ...
            ArgentConfigFile.saveDict(root)
        }
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/argent"
        state.remoteCliPath = ""
        return state
    }
}
