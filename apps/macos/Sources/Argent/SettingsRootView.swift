...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .argentSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? ArgentPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? ArgentPaths.stateDirURL.path
...
extension Notification.Name {
    static let argentSelectSettingsTab = Notification.Name("argentSelectSettingsTab")
}
