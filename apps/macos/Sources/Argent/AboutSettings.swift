...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/argent/argent") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/argent/argent")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://argent.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
                (Bundle.main.object(forInfoDictionaryKey: "ArgentBuildTimestamp") as? String) ??
                (Bundle.main.object(forInfoDictionaryKey: "ArgentBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "ArgentGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "ArgentGitCommit") as? String) ??
            "unknown"
    }
